...
**Movimento do sprite (decidido):** **opção 1 — frontal + espelho horizontal** (estilo FTL). Usa o único sheet gerado; esquerda/direita por flip; cima/baixo desliza o frame frontal. Sem sheets 4-direcionais (custo de produção alto p/ ganho imperceptível num tile pequeno). Pode evoluir p/ 4-direcional depois sem rearquitetar (troca de sheet por direção).
